...
#include "database.h"
#include "statement.h"
#include "../lib/sqlcipher/sqlite3.h"
...
NAN_METHOD(Database::New) {
	...
	//todo
	//info.This()->ForceSet(Nan::New("password"),v8::String.NewFromUtf8("123456"), ReadOnly);
...
void Database::Work_Open(uv_work_t* req) {
	...
	//todo
	sqlite3_key_v2(db->_handle, baton->filename.c_str(), baton->password.c_str(), baton->password.length());
